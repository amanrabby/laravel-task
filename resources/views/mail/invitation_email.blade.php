            ...
            <tr>
                <td>
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="text-align: left;width: 100%">
                        ...
                        <tr>
                            <td>
                                <p>You are cordially invited to join our website.</p>
                                
                                <p style="font-size: 13px;">Please follow the link below to complete your registration.</p>

                                <span style="font-weight:500">{{ route('api.registration',['token'=>$code]) }}</span>
                                
                                <p style="font-size: 13px;">Please use this token for POSTMAN.</p>
